\begin{acronym}[TDMA]
  ...
  \acro{2dm}[$2DM$]{\emph{Two Dimensional Materials}}
  \acro{2d}[$2D$]{\emph{Two Dimensional}}
  \acro{1d}[$1D$]{\emph{One Dimensional}}
  ...
  \acro{fbz}[FBZ]{First Brillouin Zone}
  \acro{cnp}[CNP]{Charge Neutrality Point}
  \acro{ll}[LL]{Landau Levels}
  \acro{kpm}[KPM]{Kernel Polynomial Method}
\end{acronym}
