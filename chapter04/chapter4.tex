...
The models used are always in the \ac{tb} approximation with a basis of localized hydrogenoid orbitals, nevertheless the number of orbitals involved in the calculation may vary depending of the specifics of each problem.
