...
Density functional calculations show\cite{Kaloni2014} that a topological band-gap opens in graphene on top of both WS$_2$ and WSe$_2$, two widely studied two dimensional \acp{tmd}.  The magnitude of this gap is in the range of a few meV, i.e.,  two or  three orders of magnitude larger than  the intrinsic \ac{soc} gap.
