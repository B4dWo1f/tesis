...
There are two ways to stack two graphene layers in a commensurate way. The first option is to align directly one layer on top of the other, so every atom in one layer is connected to an atom from the other layer\fref{Gbi_stack}a). This is the so-called $AA$-stacking.
...
We consider a 2d sheet of bilayer graphene which has $\mathcal{E}>0$ for atomic positions with $x>0$ and $\mathcal{E}<0$ otherwise.
%~~~~~~~~~~~~~~~~~~~~~~~~~~ FIGURE ~~~~~~~~~~~~~~~~~~~~~~~~~%
\begin{figure}[h!]
\centering
...
This section is a quick overview of the paper $CrI_3$ is a two dimensional ferromagnetic insulating material\cite{Klein2018,Song2018,Wang2018}, %,Jiang2018,Huang2018,Jiang2018b}
if bilayer graphene is sandwiched by two layers of $CrI_3$ as shown in \fref{cri3},
