...
It is well known that the band structure of bilayer graphene changes dramatically in the presence of an external electric field\cite{Zhang2009, Taychatanapat2010, Allen2012, Castro2010a, Ponomarenko2011, Sui2015}.
The application of an electric field has several effects in the electronic structure of the system. We will review now its main effects.
...
In particular, a band gap is open at the Dirac points as shown in \fref{Gbi_summary}{c)}.

\subsection{Rashba}
Another effect is the mixing of the $p_z$ with the other orbitals. The presence of the electric field deforms the atomic orbitals breaking the symmetries present in the purely hydrogenic orbitals. In particular the $p_z-s$ hopping is increased new hoppings between the $p_z$ and the $p_{x/y}$ orbitals appear.
