...
%%  
%%  In this thesis the electric field is treated in $\si{\eV}$ at all times and is usually introduced as
%%  \begin{equation}
%%     H_{\tex{elec}} = \mathcal{E}\Lambda
%%  \end{equation}
%%  where $\Lambda$ is the layer operator and \mathcal{E} is the strength of the electric field. The relation between the electric field $\vec{E}$ 
%%  
