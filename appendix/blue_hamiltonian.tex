...
\label{ch:blue_hamiltonian}
In this apendex we derive the effectice representation of the Hubbard model in the basis of two states which are a linear combination of atomic states (molecular states). %XXX
This term is relevant for the study of the effective interactions of pairs of in-gap states that are away in energy from the rest of single particle states. Such a scenario occurs in the case of hydrogenated bilayer (\chref{ch:designer}) and also for the case of diradical molecules, not discussed in this thesis.\cite{Ortiz2019}
...
In addition, if the molecular states are not degenerate, %XXX requirement?
