...
\FloatBarrier
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
Notice that as opposed to classical bits, a \ac{qb} can exist in a continuum of states. All the possible states of a \ac{qb} are usually mapped to the surface of a sphere such as that shown in Fig.~\ref{Bsph}.
...
The great advantage that the \ac{qc} brings is that we can actually perform operations not only in each of the basis states but in combinations of these states\cite{DiVincenzo2000}. \red{finish}
