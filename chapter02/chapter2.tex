...
This problem is the simplest example where a quantum speed up is demonstrated. Even when the speed up is only a factor $\times2$ and the problem is purely academic, it contains all the ingredients to understand the essence of quantum computing.
