...
The control of these interactions was proposed via electric gating so the electronic states could be deformed in the vicinity of the $\ce{P}$ nucleus, thus increasing/decreasing the hyperfine interaction as shown in \fref{kane_proposal}.
...
One of the advantages of bilayer graphene over $\ce{Si}:\leftidx{^{31}}{\ce{P}}$ is that nowadays there are methods to place the $\ce{H}$ adatoms with atomic precision and in a reversible way\cite{Brihuega2016,Brihuega2017}
