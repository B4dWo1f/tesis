% \chapter{ANN for topological invariants}
\chapter{ANN for topology}
\label{ch:ANN}
The research upon which this appendix is based on the publication ``Real space mapping of topological invariants using artificial neural networks'' \onlinecite{Carvalho2018}, done as a project to introduce a summer student to the vast field of neural networks.
