...
Appendices \ref{ch:QSH} and \ref{ch:ANN} are two published papers which expand on these topics. The former explores the topological character of few-layer-graphene exploring the proximity effect of different materials. The later explores the bulk-edge correspondence using neural networks to estimate the topological phase of some systems based only on a subset of the density matrix corresponding to the bulk region.
