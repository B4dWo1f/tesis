...
The vacancies are introduced in this model as an infinite on-site energy for the chosen atom(s). Unless otherwise stated everything is done in $eV$, \emph{not hopping units}, the $p_z$-$p_z$ hopping is chosen as $t=-2.7$.
